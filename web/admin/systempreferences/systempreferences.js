    ...
    .config(['$stateProvider', function($stateProvider) {
        $stateProvider
            .state('admin.systempreferences', {
                ...
                resolve: {
                    systempreferences: ['PreferenceService1', function(PreferenceService1) {
                        return PreferenceService1.GetAllSystemPreferences();
                    }]
                },
                controller: ['$scope', '$modal', '$timeout', 'systempreferences', 'PreferenceService1', 'PrivilegeService1', function($scope, $modal, $timeout, systempreferences, PreferenceService1, PrivilegeService1) {
                    ...
                    $scope.openCreatePreference = function () {
                        ...
                        modalInstance.result.then(function (systempreference) {
                            ...
                            PreferenceService1.PutSystemPreference(systempreference.key, systempreference.value, false, systempreference.notes)
                    ...
                    $scope.openEditPreference = function (systempreference) {
                        ...
                        modalInstance.result.then(function (arg) {
                            ...
                            $scope.pendingUpdate += 1;
                            PreferenceService1.UpdateSystemPreference(systempreference.id, systempreference.key, systempreference.value, systempreference.enabled, systempreference.notes)
                    ...
                    $scope.openDeletePreference = function (systempreference) {
                        ...
                        modalInstance.result.then(function (systempreference) {
                            ...
                            $scope.pendingUpdate += 1;
                            PreferenceService1.DeleteSystemPreference(systempreference.key)
                                .then(function() { $scope.pendingUpdate -= 1; });
                    ...
                    $scope.openEnableDisablePreference = function (systempreference) {
                        ...
                        modalInstance.result.then(function (systempreference) {
                            ...
                            $scope.pendingUpdate += 1;
                            PreferenceService1.UpdateSystemPreferenceEnabled(systempreference.key, !systempreference.enabled)
                                .then(function() { $scope.pendingUpdate -= 1; });
