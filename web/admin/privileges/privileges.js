    ...
    .config(['$stateProvider', function($stateProvider) {
        $stateProvider
            .state('admin.privileges', {
                ...
                resolve: {
                    privileges: ['PrivilegeService1', function(PrivilegeService1) {
                        return PrivilegeService1.GetAllPrivileges();
                    }],
                    systemPermissions: ['PrivilegeService1', function(PrivilegeService1) {
                        return PrivilegeService1.GetAllSystemPermissions();
                    }]
                },
                controller: ['$scope', '$modal', '$timeout', 'privileges', 'systemPermissions', 'PrivilegeService1', function($scope, $modal, $timeout, privileges, systemPermissions, PrivilegeService1) {
                    ...
                    $scope.openCreatePrivilege = function () {
                        ...
                        modalInstance.result.then(function (privilege) {
                            ...
                            PrivilegeService1.CreatePrivilege(privilege.name, privilege.code, privilege.description, privilege.icon, false)
                    ...
                    $scope.openEditPrivilege = function (privilege) {
                        ...
                        modalInstance.result.then(function (privilege) {
                            ...
                            $scope.pendingUpdate += 1;
                            PrivilegeService1.UpdatePrivilegeName(privilege.id, privilege.name)
                                .then(function() { $scope.pendingUpdate -= 1; });

                            $scope.pendingUpdate += 1;
                            PrivilegeService1.UpdatePrivilegeDescription(privilege.id, privilege.description)
                                .then(function() { $scope.pendingUpdate -= 1; });

                            $scope.pendingUpdate += 1;
                            PrivilegeService1.UpdatePrivilegeIcon(privilege.id, privilege.icon)
                                .then(function() { $scope.pendingUpdate -= 1; });
                    ...
                    $scope.openDeletePrivilege = function (privilege) {
                        ...
                        modalInstance.result.then(function (privilege) {
                            ...
                            $scope.pendingUpdate += 1;
                            PrivilegeService1.DeletePrivilege(privilege.id)
                                .then(function() { $scope.pendingUpdate -= 1; });
                    ...
                    $scope.openEnableDisablePrivilege = function (privilege) {
                        ...
                        modalInstance.result.then(function (privilege) {
                            ...
                            $scope.pendingUpdate += 1;
                            PrivilegeService1.UpdatePrivilegeEnabled(privilege.id, !privilege.enabled)
                                .then(function() { $scope.pendingUpdate -= 1; });
