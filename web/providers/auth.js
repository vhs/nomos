    ...
    function ($http) {
        return {
            ...
            Login: function (username, password) {
                return $http.post('/services/web/AuthService1.svc/Login', { username: username, password: password }).then(function (response) {
                    return response.data;
                });
            },
            Logout: function () {
            ...
            CountUserAccessLog: function (userid, filters) {
                return $http
                    .post('/services/web/AuthService1.svc/CountuserAccessLog', { userid: userid, filters: filters })
                    .then(function (response) {
                        return response.data;
                    });
            },
            ...
            CountAccessLog: function (filters) {
                return $http.post('/services/web/AuthService1.svc/CountAccessLog', { filters: filters }).then(function (response) {
                    return response.data;
                });
            },
            ListClients: function (page, size, columns, order, filters) {
                return $http
                    .post('/services/web/AuthService1.svc/ListClients', { page: page, size: size, columns: columns, order: order, filters: filters })
                    .then(function (response) {
                        return response.data;
                    });
            },
            CountClients: function (filters) {
                return $http.post('/services/web/AuthService1.svc/CountClients', { filters: filters }).then(function (response) {
                    return response.data;
                });
            },
