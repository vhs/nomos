...
export const zUrl = z.string().url().nullish()

export const zEmailAddress = z.coerce.string().email().min(5)

export const zUsername = z.string().min(3)

export const zHumanName = z.string().min(1)
...
export const zPaymentProviders = z.union([z.literal('PayPal'), z.literal('MoneyBookers'), z.literal('Stripe')])
...
export const zUserActiveStateType = z.object({
    title: zUserStateTitleActive,
    code: zUserStateCodeActive
})

export const zUserBannedStateType = z.object({
    title: zUserStateTitleBanned,
    code: zUserStateCodeBanned
})

export const zUserInactiveStateType = z.object({
    title: zUserStateTitleInactive,
    code: zUserStateCodeInactive
})

export const zUserPendingStateType = z.object({
    title: zUserStateTitlePending,
    code: zUserStateCodePending
})
...
export const zPositiveNumber = z.number().nonnegative()
...
export const zFunctionBoolResultFromStringArraySpread = z.function(z.tuple([]).rest(z.string()), zBoolean)
