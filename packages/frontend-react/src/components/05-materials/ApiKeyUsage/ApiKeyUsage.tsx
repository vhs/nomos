...
const ApiKeyUsage: FC<ApiKeyUsageProps> = () => {
    return (
        <div>
            ...
            <p>E.g.</p>
            <pre className='text-wrap break-words'>/services/v2/UserService2.svc/GetUsers</pre>
            <ul>
                <li>
            ...
            <pre className='spacious text-wrap break-words'>/services/v2/UserService2.svc/GetUser?id=1</pre>

            <pre className='spacious text-wrap break-words'>
            ...
            <pre className='text-wrap break-words'>/services/v2/AuthService2.svc/Login</pre>
            <p className='text-wrap break-words'>
            ...
            <pre className='text-wrap break-words'>X-Api-Key</pre>
            <p>Example request:</p>
            <pre className='text-wrap break-words'>
