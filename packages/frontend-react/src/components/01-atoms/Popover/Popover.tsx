...
// TODO make popover a clickable toggle to persist popover for easy interaction
...
const Popover: FC<PopoverProps> = ({ className, content, popover }) => (
    <div className={clsx([className, 'popover inline'])} data-testid='Popover'>
        ...
        <div className='absolute z-above-and-beyond hidden -translate-x-[50%] peer-hover:block'>
