...
import type { AdminUsersCreateSchema, AdminUsersNewProps } from './AdminUsersNew.types'
...
const AdminUsersNew: FC<AdminUsersNewProps> = () => {
    ...
    const form = useForm<AdminUsersCreateSchema>({
        resolver: zodResolver(zAdminUsersCreateSchema),
        mode: 'onChange',
        defaultValues: AdminUsersCreateDefaultValues
    })
