...
import type { SystemPreferencesNewSchema, SystemPreferencesNewProps } from './SystemPreferencesNew.types'
...
import { zAdminSystemPreferencesNewSchema } from '../SystemPreferences.schema'
import { SystemPreferencesNewDefaultValues } from '../SystemPreferences.utils'

const SystemPreferencesNew: FC<SystemPreferencesNewProps> = () => {
    ...
    const form = useForm<SystemPreferencesNewSchema>({
        resolver: zodResolver(zAdminSystemPreferencesNewSchema),
        mode: 'onChange',
        defaultValues: SystemPreferencesNewDefaultValues
    })
    ...
    const resetFields = useCallback((): void => {
        form.reset(SystemPreferencesNewDefaultValues)
    }, [form])
