...
import type { AllowedPageSizes } from '@/components/06-integrated-pages/TablePage/TablePage.schema'
import { tablePageDefaults } from '@/components/06-integrated-pages/TablePage/TablePage.utils'
