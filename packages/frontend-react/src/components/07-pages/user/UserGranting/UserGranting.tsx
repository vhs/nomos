...
import type { UserGrantingProps, UserGrantingSchema } from './UserGranting.types'
...
import { zUserGrantingSchema } from './UserGranting.schema'
import { UserGrantingDefaultValues } from './UserGranting.utils'
import UserGrantingItem from './UserGrantingItem/UserGrantingItem'
...
const UserGranting: FC<UserGrantingProps> = () => {
    ...
    const form = useForm<UserGrantingSchema>({
        ...
        mode: 'onChange',
        defaultValues: UserGrantingDefaultValues
    })
