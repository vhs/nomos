...
EOF
    echo "import { $(grep 'export const z' ./src/lib/validators/common.ts | awk '{ print $3 }' | cut -c2- | sort | xargs | tr ' ' ',')} from '@/types/validators/common'"
    echo "import { $(grep 'export const z' ./src/lib/validators/records.ts | awk '{ print $3 }' | cut -c2- | sort | xargs | tr ' ' ',')} from '@/types/validators/records'"
