-- --------------------------------------------------------------------------------
-- 
-- @version: msm.sql Jul 14, 2011 23:36 gewa
-- @package CMS Pro
...
INSERT INTO `settings` (`site_name`, `site_email`, `site_url`, `reg_allowed`, `user_limit`, `reg_verify`, `notify_admin`, `auto_verify`, `user_perpage`, `thumb_w`, `thumb_h`, `backup`, `version`) VALUES ('Your Site Name', 'gewa@rogers.com', 'http://agda-graph/msm', '1', '0', '1', '0', '1', '10', '120', '100', '', '2.0');
