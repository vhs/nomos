...
<div class="box">
  <form action="https://www.moneybookers.com/app/payment.pl" method="post" id="mb_form" name="mb_form">
    <table class="myTable">
      ...
      <tr class="nohover">
        <td colspan="2"><input type="image" src="gateways/moneybookers/moneybookers_big.png" style="vertical-align:middle;border:0;width:180px;margin-right:10px" name="submit" title="Pay With Moneybookers" alt="" onclick="document.mb_form.submit();"/></td>
      </tr>
    </table>
